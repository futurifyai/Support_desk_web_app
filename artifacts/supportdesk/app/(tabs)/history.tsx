...
function makeStyles(colors: ReturnType<typeof useColors>, isDark: boolean) {
  return StyleSheet.create({
    ...
    iconBtn: { width: 36, height: 36, borderRadius: 10, backgroundColor: colors.secondary, borderWidth: 1, borderColor: colors.border, alignItems: "center", justifyContent: "center" },
    scroll: { flex: 1 },
    ...
    filterToggle: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 11, paddingVertical: 9, borderRadius: 9, borderWidth: 1, borderColor: colors.primary, backgroundColor: isDark ? "rgba(99,102,241,0.09)" : "rgba(99,102,241,0.05)" },
    ...
    savedSection: { padding: 14, gap: 9, borderRadius: 13, borderWidth: 1, borderColor: isDark ? "rgba(99,102,241,0.28)" : "rgba(99,102,241,0.18)", backgroundColor: isDark ? "rgba(99,102,241,0.08)" : "rgba(99,102,241,0.04)" },
